...
flowchart TD
  ...
  E --> F["กรอกจำนวนเต็ม หน่วย ต้นทุน/สกุลเงิน<br/>จุดเก็บ วันหมดอายุ วันที่รับเข้า หมายเหตุ/รูป"]
...
- จุดเก็บ/คลังย่อย เก็บอยู่ในฟิลด์ `requester` ของรายการรับเข้า
- วันที่รับเข้า วันหมดอายุ หมายเหตุ รูปสินค้า และเวลาที่ระบบบันทึก
- จุดเก็บของรายการรับเข้าถูกนำไปหา “ที่เก็บ” ในเอกสารใบเบิก โดยจับคู่สินค้าและวันหมดอายุ
...
- รายการสินค้า จำนวน หน่วย และที่เก็บ
- หมายเหตุ
...
| `products` | ข้อมูลหลักสินค้า SKU ประเภท หมวด หน่วย ต้นทุน min/max จุดเก็บเริ่มต้น วันหมดอายุเริ่มต้น และ `isActive` |
| `product_categories` | รายชื่อหมวดหมู่ และเมื่อเปลี่ยนชื่อหมวด ระบบอัปเดตทั้ง `products` และ `transactions` |
| `transactions` | ข้อมูลที่ใช้จริงสำหรับรับเข้า เบิก สถานะ ต้นทุน วันหมดอายุ จุดเก็บ และคำนวณสต๊อก |
...
- `requester` ของ `type=out` หมายถึงผู้ขอเบิก แต่ `requester` ของ `type=in` ถูกใช้เป็นจุดเก็บ/คลังย่อย
...
เมื่อ Admin รับสินค้าเข้า ระบบจะบันทึกข้อมูลสินค้า จำนวน ต้นทุน จุดเก็บ วันที่รับเข้า และวันหมดอายุลงในฐานข้อมูล จากนั้นยอดสต๊อก หน้าเลือกสินค้า และ Dashboard จะอัปเดตจากข้อมูลชุดเดียวกัน
